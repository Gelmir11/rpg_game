...
export class BootScene extends Phaser.Scene {
  ...
  drawEquipLayer(g, x, y, d, f, slot, color) {
    ...
    if (slot === 'chest') {
      ...
      g.fillStyle(c);
      g.fillRect(x + 17 + walk, y + 54, 11, 32);
      g.fillRect(x + 35 - walk, y + 54, 11, 32);
      g.fillRect(x + 16, y + 50, 32, 6);
      // Shoe/boot cuff at bottom
      g.fillStyle(cDark);
      g.fillRect(x + 17 + walk, y + 82, 11, 4);
      g.fillRect(x + 35 - walk, y + 82, 11, 4);
    } else if (slot === 'head') {
      // Helmet
  ...
  drawEquipLayerFemale(g, x, y, d, f, slot, color) {
    ...
    if (slot === 'chest') {
      ...
      g.fillStyle(c);
      g.fillRect(x + 19 + walk, y + 54, 9, 32);
      g.fillRect(x + 36 - walk, y + 54, 9, 32);
      g.fillRect(x + 18, y + 50, 28, 6);
      g.fillStyle(cDark);
      g.fillRect(x + 19 + walk, y + 82, 9, 4);
      g.fillRect(x + 36 - walk, y + 82, 9, 4);
    } else if (slot === 'head') {
  ...
  generateItemSprites() {
    ...
    const items = [
      ...
      { key: 'icon_ring_strength', draw: g=>{}, px: [
        ...
        '................',
        '................',
      ], pal: {'.':0,'G':0xB8860B,'Y':0xDAA520,'D':0x880000,'R':0xCC0000,'r':0xFF4444}},
      { key: 'icon_ring_defense', draw: g=>{}, px: [
        ...
        '................',
        '................',
      ], pal: {'.':0,'G':0x2a5a8a,'S':0x4682B4,'D':0x005588,'B':0x0088CC,'b':0x44BBFF,'C':0x3a7aAA}},
